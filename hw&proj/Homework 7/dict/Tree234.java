...
public class Tree234 extends IntDictionary {
    ...
    public void insert(int key) {
        ...
        if (root.keys == 3) {
            ...
            Tree234Node new1 = new Tree234Node(newRoot, root.key1);
            Tree234Node new2 = new Tree234Node(newRoot, root.key3);
            Tree234Node c1 = root.child1;
            Tree234Node c2 = root.child2;
            Tree234Node c3 = root.child3;
            Tree234Node c4 = root.child4;
            if (c1 != null) {
                c1.parent = new1;
            }
            if (c2 != null) {
    ...
    public Tree234Node floatingUp(Tree234Node node, int key){
        Tree234Node parent = node.parent;
        int k2 = node.key2;
        int k1 = node.key1;
        int k3 = node.key3;
        Tree234Node newNode1 = new Tree234Node(parent, k1);
        Tree234Node newNode2 = new Tree234Node(parent, k3);
        if (parent.keys == 1) {
            if (k2 < parent.key1) {
            ...
            if (k2 < parent.key1) {
                ...
                parent.child1 = newNode1;
                parent.child2 = newNode2;
            } else if (k2 > parent.key1 && k2 < parent.key2) {
                parent.key3 = parent.key2;
                parent.key2 = k2;
                parent.child4 = parent.child3;
                parent.child2 = newNode1;
