...
public class PixImage {
    ...
    public PixImage boxBlur(int numIterations) {
        ...
        return recurBoxBlur(numIterations, this);
    }


    public PixImage recurBoxBlur(int numIterations, PixImage pig) {
        if (numIterations == 0) {
            return pig;
        }
        int w = pig.getWidth();
        int h = pig.getHeight();
        PixImage newPig = new PixImage(w, h);
        ...
        numIterations--;
        return recurBoxBlur(numIterations, newPig);
    }
    ...
    private short[] findNeighbours(int w, int h) {
        ...
        short neighboursCnt = (short) neighbours.size();
        short red = 0;
        short green = 0;
        short blue = 0;
